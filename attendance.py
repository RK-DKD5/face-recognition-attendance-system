...
class Attendance:
    def __init__(self, root):
        ...
        try:
            img = Image.open(
                r"C:\Users\ronak\OneDrive\Pictures\Documents\Attachments\Desktop\face detection\img\sd.jpg"
            )
        ...
        # ================= Inner Frame =================
        left_inside_frame = Frame(Left_frame, bd=2, relief=RIDGE, bg="gray")
        left_inside_frame.place(x=5, y=10, width=710, height=250)
        ...
        btn_frame.place(x=30, y=300, width=640, height=38)
        ...
        table_frame.place(x=5, y=50, width=695, height=600)
